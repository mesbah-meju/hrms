...
<div class="container-fluid">
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
            <a href="{{ route('payGrade.index') }}"
                class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i
                    class="fa fa-list-ul" aria-hidden="true"></i> @lang('paygrade.view_pay_grade') </a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        @if (isset($editModeData))
                            {{ Form::model($editModeData, ['route' => ['payGrade.update', $editModeData->pay_grade_id], 'method' => 'PUT', 'files' => 'true', 'id' => 'payGradeForm', 'class' => 'ajaxFormSubmit', 'data-redirect' => route('payGrade.index')]) }}
                        @else
                            {{ Form::open(['route' => 'payGrade.store', 'enctype' => 'multipart/form-data', 'id' => 'payGradeForm', 'class' => 'ajaxFormSubmit', 'data-redirect' => route('payGrade.index')]) }}
                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('paygrade.pay_grade_name')<span
                                                class="validateRq">*</span></label>
                                        {!! Form::text(
                                            'pay_grade_name',
                                            old('pay_grade_name'),
                                            $attributes = [
                                                'class' => 'form-control required pay_grade_name',
                                                'id' => 'pay_grade_name',
