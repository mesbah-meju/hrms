                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group training_type_id">
                                        ...
                                        {{ Form::select('training_type_id', $trainingTypeList, old('training_type_id'), ['class' => 'form-control training_type_id required select2']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text(
                                            'start_date',
                                            isset($editModeData) ? dateConvertDBtoForm($editModeData->start_date) : old('start_date'),
                                            $attributes = [
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text(
                                            'end_date',
                                            isset($editModeData) ? dateConvertDBtoForm($editModeData->end_date) : old('end_date'),
                                            $attributes = [
                                                'class' => 'form-control required dateField',
                                                'readonly' => 'readonly',
                                                'id' => 'end_date',
