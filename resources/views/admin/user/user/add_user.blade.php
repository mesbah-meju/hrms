									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												...
												{{ Form::select('role_id',$data, old('role_id'), array('class' => 'form-control role_id select2 required','data-style'=>'btn-info btn-outline')) }}
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
											  <label for="exampleInput">User Name<span class="validateRq">*</span></label>
												{!! Form::text('user_name', old('user_name'), $attributes = array('class'=>'form-control required user_name','id'=>'user_name','placeholder'=>'Enter your user name')) !!}
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												{{ Form::select('status', array('1' => 'Active', '2' => 'Inactive'), old('status'), array('class' => 'form-control status select2 required')) }}
											</div>
										</div>
									</div>
								</div>
