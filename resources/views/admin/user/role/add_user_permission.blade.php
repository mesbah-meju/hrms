            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::open(['route' => 'rolePermission.store', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal ajaxFormSubmit', 'id' => 'permissionCreate', 'data-redirect' => route('rolePermission.index')]) }}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-8 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="role">@lang('role.user_role')<span class="validateRq">*</span></label>
                                        {{ Form::select('role_id', $data, old('role_id'), ['class' => 'form-control role_id select2 required', 'onchange' => 'getMenu(this)', 'id' => 'role_id']) }}
                                    </div>
                                </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-6">
                                    <button type="submit" id="formSubmit" disabled="disabled"
