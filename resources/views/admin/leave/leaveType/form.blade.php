            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        @if (isset($editModeData))
                            {{ Form::model($editModeData, ['route' => ['leaveType.update', $editModeData->leave_type_id], 'method' => 'PUT', 'files' => 'true', 'id' => 'leaveTypeForm', 'class' => 'form-horizontal ajaxFormSubmit', 'data-redirect' => route('leaveType.index')]) }}
                        @else
                            {{ Form::open(['route' => 'leaveType.store', 'enctype' => 'multipart/form-data', 'id' => 'leaveTypeForm', 'class' => 'form-horizontal ajaxFormSubmit', 'data-redirect' => route('leaveType.index')]) }}
                        @endif
