                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 day_name">
                                            {{ Form::select('day_name', $weekList, old('day_name'), ['class' => 'form-control day_name select2 required']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label class="control-label col-md-4">@lang('common.status')<span
                                                class="validateRq">*</span></label>
                                        <div class="col-md-8">
                                            {{ Form::select('status', ['1' => __('common.active'), '2' => __('common.inactive')], old('status'), ['class' => 'form-control status select2 required']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
