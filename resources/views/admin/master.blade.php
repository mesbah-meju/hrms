                ...
                <div class="top-left-part">
                    ...
                    <a class="logo" href="{{ url('dashboard') }}">
                        <!-- Logo icon image, you can use font-icon also --><b>
                            <!--This is dark logo icon--><img style="width: 125px;"
                ...
                <ul class="nav navbar-top-links navbar-left">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu mailbox animated bounceInDown"
                            ...
                            <li>
                                @foreach (getAllLanguageList() as $key => $lang)
                                    <div class="message-center">
                                        <a href="{{ url('local/' . $key) }}">
...
if ($employeeInfo[0]->photo != '' &&  file_exists('uploads/employeePhoto/' . $employeeInfo[0]->photo)) {
    ?>
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img
                                src="{!! asset('uploads/employeePhoto/' . $employeeInfo[0]->photo) !!}" alt="user-img" width="36" class="img-circle"><b
                                class="hidden-xs " style="color: #fff !important;">{!! $employeeInfo[0]->user_name !!}</b><span
                                class="caret"></span>
                        </a>
                        <?php } else {?>
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img
                                src="{!! asset('admin_assets/img/default.png') !!}" alt="user-img" width="36" class="img-circle"><b
                                class="hidden-xs" style="color: #fff !important; "><span class="hideMenu"
                                    style="color: #fff !important;">{!! $employeeInfo[0]->user_name !!}</span></b><span
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <div class="user-profile">
                    <div class="dropdown user-pro-body">
                        ...
                        <div><img src="{!! asset('uploads/employeePhoto/' . $employeeInfo[0]->photo) !!}" alt="user-img" class="img-circle"></div>
                        <?php } else {?>
                        ...
                        <a href="#" class="dropdown-toggle u-dropdown " data-toggle="dropdown" role="button"
                            aria-haspopup="true" aria-expanded="false"><span
                                class="hideMenu">{!! $employeeInfo[0]->user_name !!}</span> </a>
        ...
        <footer class="footer text-center">
            {{ date('Y') }} &copy; <strong><a href="https://fouraxiz.com"
                    target="_blank">4axiz</a>
    ...
    @include('partials.ajax_form_submit')
    @yield('page_scripts')
