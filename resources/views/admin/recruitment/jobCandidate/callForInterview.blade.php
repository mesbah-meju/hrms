						...
						<div class="panel-heading">{{$results->applicant_name}}</div>
							<div class="col-md-4" style="margin-top: 16px;">
								...
								<div class="input-group">
									...
									{!! Form::text('interview_date',old('interview_date'), $attributes = array('class'=>'form-control required dateField','id'=>'interview_date','placeholder'=>'Enter interview date','readonly')) !!}
								</div>
							</div>
							<div class="col-md-4" style="margin-top: 16px;">
								<label for="exampleInput">Interview Date<span class="validateRq">*</span></label>
								<div class="input-group">
									...
									<div class="bootstrap-timepicker">
										{!! Form::text('interview_time',old('interview_time'), $attributes = array('class'=>'form-control required timePicker','id'=>'timePicker','placeholder'=>'Enter time','readonly')) !!}
									</div>
								</div>
							</div>
							<div class="col-md-4"  style="margin-top: 16px;">
								<div class="form-group">
									...
									{{ Form::select('interview_type', array('Email' => 'Email'), old('interview_type'), array('class' => 'form-control interview_type select2 required')) }}
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									{!! Form::textarea('comment',old('comment'), $attributes = array('class'=>'form-control textarea_editor required','rows'=>'8','id'=>'comment','placeholder'=>'Enter comment...')) !!}
