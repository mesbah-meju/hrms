                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            {{ Form::select('performance_category_id', $performanceCategory, old('performance_category_id'), ['class' => 'form-control performance_category_id select2 required']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
