        ...
        <div class="container">
            ...
            <div>
                <a href="{{ url('/') }}" class="logo">
                    <img src="{{ url('uploads/front/' . $front_setting->logo) }}" alt="" class="logo-light" style="height: 70px;" />
            ...
            <div class="buy-button">
                ...
                <a href="{{ url('dashboard') }}" class="btn btn-primary"><i class="mdi mdi-dashboard"></i>
                    Dashboard</a>
                @else
                    @if (Auth::check())
                    <a href="{{ url('dashboard') }}" class="btn btn-primary"><i class="mdi mdi-dashboard"></i>
                        Dashboard</a>
                    @else
                    <a href="{{ url('login') }}" class="btn btn-primary"><i class="mdi mdi-dashboard"></i>
                        Login</a>
                    @endif
