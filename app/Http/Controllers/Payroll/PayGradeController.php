...
use App\Models\PayGradeToAllowance;
use App\Models\PayGradeToDeduction;
use Carbon\Carbon;
...
class PayGradeController extends Controller
{
    ...
    public function store(PayGradeRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            return ajaxResponse(200, 'Pay grade Successfully saved.');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function update(PayGradeRequest $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return ajaxResponse(200, 'Pay grade Successfully Updated.');
        } catch (\Exception $e) {
            DB::rollback();
            Log::error($e->getMessage());
            return ajaxResponse(400, 'Something Error Found !, Please try again.');
