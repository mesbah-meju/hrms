...
use App\Models\EmployeePerformanceDetails;
...
class EmployeePerformanceController extends Controller
{
    ...
    public function store(EmployeePerformanceRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            return ajaxResponse(200, 'Employee Performance Successfully saved.');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function update(EmployeePerformanceRequest $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return ajaxResponse(200, 'Employee Performance Successfully Updated.');
        } catch (\Exception $e) {
            DB::rollback();
            Log::error($e->getMessage());
            return ajaxResponse(500, 'Internal Server Error');
