...
class LeaveRepository
{
    ...
    {
        $holidays  = DB::select("CALL SP_getHoliday('" . $application_from_date . "','" . $application_to_date . "')");
        $public_holidays = [];
    ...
    public function calculateEmployeeLeaveBalance($leave_type_id, $employee_id)
    {
        if ($leave_type_id == 1) {
            ...
            $leaveBalance = DB::select("CALL SP_calculateEmployeeLeaveBalance('" . $employee_id . "','" . $leave_type_id . "')");
